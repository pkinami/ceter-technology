...
export const permissionCatalog: Array<{
  ...
  { module: "PRODUCTS", action: "EXPORT", description: "Export product catalogue data" },
...
const roleCatalog = [
  ...
  },
  {
    ...
    description: "Products, categories, brands, catalogue media, and imports.",
    permissions: [
      "products.view",
      "products.create",
      "products.edit",
  ...
  },
  {
    ...
    description: "Stock levels, supplier stock updates, inventory imports, and replenishment alerts.",
    permissions: ["products.view", "products.edit", "products.bulk", "reports.view"],
  },
  {
    name: "Sales Manager",
    slug: "sales-manager",
    description: "Customer orders, delivery status, customers, and sales reports.",
    permissions: ["orders.view", "orders.edit", "orders.cancel", "orders.update_status", "customers.view", "reports.view", "reports.export"],
  },
  {
