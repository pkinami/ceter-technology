...
-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('ACTIVE', 'OUT_OF_STOCK', 'DRAFT', 'NEEDS_ATTENTION');
...
-- CreateEnum
CREATE TYPE "DataSourceType" AS ENUM ('MANUFACTURER', 'SUPPLIER', 'DISTRIBUTOR', 'RETAILER');

-- CreateEnum
CREATE TYPE "ConnectionType" AS ENUM ('API', 'EXCEL', 'CSV', 'XML', 'JSON', 'WEB_CATALOGUE');

-- CreateEnum
CREATE TYPE "SourceCountry" AS ENUM ('KENYA', 'INTERNATIONAL');

-- CreateEnum
CREATE TYPE "UpdateFrequency" AS ENUM ('HOURLY', 'DAILY', 'WEEKLY', 'MONTHLY');

-- CreateEnum
CREATE TYPE "IntegrationStatus" AS ENUM ('ACTIVE', 'INACTIVE');

-- CreateEnum
CREATE TYPE "AutomationJobType" AS ENUM ('MANUFACTURER_SYNC', 'SUPPLIER_SYNC', 'CATALOGUE_IMPORT', 'IMAGE_COLLECTION', 'SPEC_EXTRACTION', 'PRODUCT_ENRICHMENT', 'PRICE_UPDATE', 'MARKET_PRICE_CHECK', 'INVENTORY_UPDATE', 'SEO_GENERATION', 'MARKETING_ANALYSIS', 'BUSINESS_REPORT');

-- CreateEnum
CREATE TYPE "AutomationJobStatus" AS ENUM ('QUEUED', 'RUNNING', 'COMPLETED', 'FAILED');

-- CreateEnum
CREATE TYPE "ProductSourceStatus" AS ENUM ('DETECTED', 'ENRICHED', 'MATCHED', 'READY_FOR_REVIEW', 'NEEDS_ATTENTION', 'PUBLISHED', 'REJECTED');

-- CreateEnum
CREATE TYPE "DiscoveryStatus" AS ENUM ('NEW', 'EXISTING', 'DUPLICATE', 'NEEDS_ATTENTION', 'APPROVED', 'PUBLISHED');

-- CreateEnum
CREATE TYPE "QualityCheckStatus" AS ENUM ('PASSED', 'NEEDS_ATTENTION', 'FAILED');

-- CreateEnum
CREATE TYPE "MatchConfidence" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'EXACT');

-- CreateEnum
CREATE TYPE "PriceRuleScope" AS ENUM ('GLOBAL', 'CATEGORY', 'BRAND', 'PRODUCT');

-- CreateEnum
CREATE TYPE "ImageSourcePriority" AS ENUM ('MANUFACTURER', 'DISTRIBUTOR', 'APPROVED_RETAILER', 'SUPPLIER', 'MANUAL');
...
-- CreateTable
CREATE TABLE "ProductQualityCheck" (
    "id" TEXT NOT NULL,
    "productId" TEXT,
    "productSourceId" TEXT,
...
-- CreateIndex
CREATE INDEX "DataSource_updateFrequency_idx" ON "DataSource"("updateFrequency");
...
-- CreateIndex
CREATE INDEX "ProductSource_dataSourceId_idx" ON "ProductSource"("dataSourceId");

-- CreateIndex
CREATE INDEX "ProductSource_manufacturerId_idx" ON "ProductSource"("manufacturerId");

-- CreateIndex
CREATE INDEX "ProductSource_brand_idx" ON "ProductSource"("brand");

-- CreateIndex
CREATE INDEX "ProductSource_modelNumber_idx" ON "ProductSource"("modelNumber");

-- CreateIndex
CREATE INDEX "ProductSource_sku_idx" ON "ProductSource"("sku");

-- CreateIndex
CREATE INDEX "ProductSource_status_idx" ON "ProductSource"("status");
...
-- CreateIndex
CREATE INDEX "SupplierProduct_dataSourceId_idx" ON "SupplierProduct"("dataSourceId");
...
-- CreateIndex
CREATE INDEX "ProductMatch_productSourceId_idx" ON "ProductMatch"("productSourceId");

-- CreateIndex
CREATE INDEX "ProductMatch_primaryProductId_idx" ON "ProductMatch"("primaryProductId");

-- CreateIndex
CREATE INDEX "ProductMatch_candidateProductId_idx" ON "ProductMatch"("candidateProductId");
...
-- CreateIndex
CREATE INDEX "AutomationJob_dataSourceId_idx" ON "AutomationJob"("dataSourceId");

-- CreateIndex
CREATE INDEX "AutomationJob_createdAt_idx" ON "AutomationJob"("createdAt");

-- CreateIndex
CREATE INDEX "ProductDiscovery_productSourceId_idx" ON "ProductDiscovery"("productSourceId");

-- CreateIndex
CREATE INDEX "ProductDiscovery_productId_idx" ON "ProductDiscovery"("productId");

-- CreateIndex
CREATE INDEX "ProductDiscovery_dataSourceId_idx" ON "ProductDiscovery"("dataSourceId");

-- CreateIndex
CREATE INDEX "ProductDiscovery_status_idx" ON "ProductDiscovery"("status");

-- CreateIndex
CREATE INDEX "ProductDiscovery_detectedBrand_idx" ON "ProductDiscovery"("detectedBrand");

-- CreateIndex
CREATE INDEX "ProductQualityCheck_productId_idx" ON "ProductQualityCheck"("productId");

-- CreateIndex
CREATE INDEX "ProductQualityCheck_productSourceId_idx" ON "ProductQualityCheck"("productSourceId");

-- CreateIndex
CREATE INDEX "ProductQualityCheck_status_idx" ON "ProductQualityCheck"("status");

-- CreateIndex
CREATE INDEX "ProductQualityCheck_checkedAt_idx" ON "ProductQualityCheck"("checkedAt");

-- CreateIndex
CREATE INDEX "AutomationLog_automationJobId_idx" ON "AutomationLog"("automationJobId");

-- CreateIndex
CREATE INDEX "AutomationLog_dataSourceId_idx" ON "AutomationLog"("dataSourceId");
...
-- CreateIndex
CREATE INDEX "ImageSource_productId_idx" ON "ImageSource"("productId");

-- CreateIndex
CREATE INDEX "ImageSource_productSourceId_idx" ON "ImageSource"("productSourceId");

-- CreateIndex
CREATE INDEX "ImageSource_dataSourceId_idx" ON "ImageSource"("dataSourceId");

-- CreateIndex
CREATE INDEX "ImageSource_source_idx" ON "ImageSource"("source");

-- CreateIndex
CREATE INDEX "ImageSource_isVerified_idx" ON "ImageSource"("isVerified");

-- CreateIndex
CREATE INDEX "CatalogueImport_dataSourceId_idx" ON "CatalogueImport"("dataSourceId");

-- CreateIndex
CREATE INDEX "CatalogueImport_status_idx" ON "CatalogueImport"("status");

-- CreateIndex
CREATE INDEX "CatalogueImport_createdAt_idx" ON "CatalogueImport"("createdAt");
